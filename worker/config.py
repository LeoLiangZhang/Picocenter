...
class ConfigBase:
    ...
    log_level = "info"  # options are debug, warning, error
...
class WorkerConfig(ConfigBase):
    ...
    block_size = 4096*32 # please match this number to what run-fuse.sh PICO_BLOCK_SIZE vaiable
    ...
    local_run = False
    eth0addr = get_ip_address(ETH_NAME)
    #eth0addr = get_public_ec2_addr()
    ...
    def get_local_addr(self, ifname=ETH_NAME):
